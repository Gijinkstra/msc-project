...
\begin{equation}
    ...
    \zeta_{i} = \frac{-\Re(\lambda_{c,i})}{\abs{\lambda_{c,i}}}.
\end{equation}
...
If the provided value is $0 < m < 1$, the tolerance will act as a cutoff level on the normalised singular values. The maximum even number of modes above the cutoff will be retained.